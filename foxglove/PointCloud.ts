...
function createBasePointCloud(): PointCloud {
  return { timestamp: undefined, frameId: "", pose: undefined, pointStride: 0, fields: [], data: new Uint8Array(0) };
}

export const PointCloud: MessageFns<PointCloud> = {
  encode(message: PointCloud, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.fields) {
      PackedElementField.encode(v!, writer.uint32(42).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PointCloud {
